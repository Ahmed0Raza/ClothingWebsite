...
export default function OrderDetailsPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      console.log("detailsoforder", resp);
      if (resp.status !== "ok") {
        navigate("/404");
      }
      setOrder(resp.order);
  ...
  return (
    <main className="relative mb-20 my-10">
        ...
        <OrderDetailsSection heading="Status:">
          ...
          <div className="text-center space-y-2">
            ...
            <div className="space-x-1">
              ...
              <span className="font-light">+92 3137676465</span>
            </div>
          </div>
        </OrderDetailsSection>
        ...
        <OrderDetailsSection heading="Products:">
          <div className="flex flex-col items-center gap-2">
            {order.products.map(p => (
              ...
              <Link key={p._id} to={`/product/${p.productID._id}`}>
                <OrderProduct
                  title={p.title}
                  SCQ={p.SCQ}
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-2xl font-light">PKR {order.amount}</p>
          </div>
        </OrderDetailsSection>
      </Container>
